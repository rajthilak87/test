...
String testCaseName = 'Tutor Paynow Report'
def filterBy = ['paynow', 'tutor']
def data = WebUtil.getData(GlobalVariable.projectRootPath + '\\TestDataXls\\tutor paynow.xlsx', 'Paynow', filterBy)
...
for (def row : data)
	{
        ...
        FailureHandling.CONTINUE_ON_FAILURE)	
		   WebUI.callTestCase(findTestCase('Test Cases/Generic/Tutor Paynow General'), [('testCaseName') : testCaseName, ('testCaseData') : row],
		   FailureHandling.CONTINUE_ON_FAILURE)
		}		
