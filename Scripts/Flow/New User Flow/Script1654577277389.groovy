...
String testCaseName = 'New user Report'
...
for (def row : data)
	{
		...
		WebUI.callTestCase(findTestCase('Flow/tutor start'), [('testCaseName') : testCaseName, ('testCaseData') : row], FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.delay(5)
