...
String testCaseName = 'Forget Pass Tutor Report'

//get user name and pw to login
def filterBy = ['frgt_pass','tutor']
...
for (def row : data) {
 ...
 //   FailureHandling.CONTINUE_ON_FAILURE)  
    ...
    WebUI.callTestCase(findTestCase('Generic/Tutor Forget Pass General'), [('testCaseName') : testCaseName, ('testCaseData') : row], 
        FailureHandling.CONTINUE_ON_FAILURE)
	...
	WebUI.callTestCase(findTestCase('Generic/Forget Pass Tutor General 1'), [('testCaseName') : testCaseName, ('testCaseData') : row],
		FailureHandling.CONTINUE_ON_FAILURE)
