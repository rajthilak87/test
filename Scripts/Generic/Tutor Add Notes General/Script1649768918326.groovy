...
page: for (int z=0; z<6; z++) 
	...
	WebUI.delay(2)
	WebUI.click(findTestObject('Object Repository/Notes/Notes Link'))
	WebUI.delay(2)	
	
}
catch (org.openqa.selenium.NoSuchElementException | com.kms.katalon.core.exception.StepFailedException  e)
{
	WebUtil.reportAndtakeScreenshot(testCaseName, testCaseData, 'Tutor Notes has error : ' + e.getMessage(),true)
}