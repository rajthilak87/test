...
try {
	WebUI.click(findTestObject('Object Repository/Milestone/Add milestone'))
	WebUI.delay(2)
	WebUI.setText(findTestObject('Object Repository/Milestone/Text Box'), testCaseData.Milestone_name)
	WebUI.delay(1)
	WebUI.click(findTestObject('Object Repository/Milestone/submit'))
	WebUI.delay(2)
}
