...
if (choosesigin == 'n') {
	...
	WebUtil.clickElement('Object Repository/sign-in/tutor/div_Tutor Login')
	
	WebUtil.tutorLoginForm(testCaseName, testCaseData)
	...
	WebUtil.tutfbLoginForm(testCaseName, testCaseData)
	...
	WebUtil.tutgmLoginForm(testCaseName, testCaseData)
}