...
try {
	WebUI.click(findTestObject('Object Repository/Notes/Add Notes'))
	WebUI.delay(1)
	WebUI.setText(findTestObject('Object Repository/Milestone/Text Box'), testCaseData.notes_title)
	WebUI.delay(1)
